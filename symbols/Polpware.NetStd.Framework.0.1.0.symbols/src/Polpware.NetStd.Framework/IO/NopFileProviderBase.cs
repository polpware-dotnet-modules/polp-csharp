...
namespace Polpware.NetStd.Framework.IO
{
    ...
    /// </summary>
    public class NopFileProviderBase : PhysicalFileProvider, INopFileProvider
    {

        public NopFileProviderBase(string root) : base(root) { }
